    ...
    public class ShopController : Controller
    {
        ...
        public ActionResult Checkout(CheckoutViewModel checkout)
        {
            ...
            using (var db = new ApplicationDbContext())
            {
                ...
                order.CardNumberLastForDigit = checkout.CardNumber.Substring(12, 4);
                ...
                /*
                 ...
                 if(result == success) ödeme yapılmıştır. hata varsa hatayı kullanıcıya göster

                banka api si elimizde olmadığı için yapamıtyoruz.
                 */
                db.Orders.Add(order);
                db.SaveChanges();
